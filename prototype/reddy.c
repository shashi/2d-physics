...
//	if(t1!=0||t2!=0)
	...
	bres(xc1,yc1,xc1+50*cos(theta),yc1+50*sin(theta));
	bres(xc2,yc2,xc2+50*cos(theta),yc2+50*sin(theta));
	bres(xc3,yc3,xc3+50*cos(theta),yc3+50*sin(theta));
	glColor3f(0,1,0);
